...
# [Recursive Data Structures](https://www.codecademy.com/courses/learn-recursion-python/lessons/recursion-python/exercises/recursion-python-trees)
...
Trees which are referenced by other trees are known as *children*. 
Trees which hold references to other trees are known as the *parents*.
