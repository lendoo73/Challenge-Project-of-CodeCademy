...
# [Graph Review](https://www.codecademy.com/courses/complex-data-structures/lessons/python-graphs/exercises/python-graphs-review)

We’ve implemented a robust graph data structure in Python. 
Our two classes, `Vertex` and `Graph` are capable of representing the typical variations in graphs that occur in many different algorithms.
